...
function __oc_prepare_completions
    ...
    set -l results (__oc_perform_completion)
    __oc_debug "Completion results: $results"
    ...
    set --global __oc_comp_results $results[1..-2]
...
complete -c oc -n '__oc_prepare_completions' -f -a '$__oc_comp_results'
